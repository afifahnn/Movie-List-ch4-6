...
export const Register = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-screen bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-rose-900 via-amber-800 to-rose-400 px-[1rem]'>
